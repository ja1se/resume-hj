...
const THEME_STYLES = {
  light: "bg-white/95 backdrop-blur-md text-slate-900 border-slate-200 shadow-sm",
  dark: "bg-slate-950/95 backdrop-blur-md text-white border-slate-800 shadow-lg",
};
          ...
          {links.map(({ label, href }) => (
            <li key={href}>
              <button
                ...
                className={cn(
                  "px-4 py-2 rounded-full text-[16px] font-light transition-all duration-200",
